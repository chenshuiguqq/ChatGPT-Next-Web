...
const cs: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} zpráv s AI`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Zpráva z AI",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Vynutit přidání simulovaného systémového promptu AI na začátek seznamu zpráv každého požadavku",
    },
    Update: {
