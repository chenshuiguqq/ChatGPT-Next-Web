...
const no: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} meldinger med AI`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Melding fra AI",
  },
  Memory: {
    Title: "Minneinstruks",
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Tving tillegg av en simulert AI-systemprompt i begynnelsen av meldingslisten for hver forespørsel",
    },
    Update: {
