...
const es: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} mensajes con AI`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Mensaje de AI",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Agregar forzosamente un prompt de sistema simulado de AI al comienzo de la lista de mensajes en cada solicitud",
    },
    Update: {
