...
const fr: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} messages échangés avec AI`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Message de AI",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Ajoute de force une invite système simulée de AI au début de la liste des messages pour chaque demande",
    },
    InputTemplate: {
      Title: "Template",
