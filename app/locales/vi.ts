...
const vi: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} tin nhắn với AI`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Tin nhắn từ AI",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Bắt buộc thêm một prompt hệ thống giả lập AI ở đầu danh sách tin nhắn cho mỗi yêu cầu",
    },
    Update: {
