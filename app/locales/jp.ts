...
const jp: PartialLocaleType = {
  WIP: "この機能は開発中です",
  Error: {
    Unauthorized: "ブラウザのキャッシュをクリアして、もう一度お試しください。",
  ...
  Chat: {
    SubTitle: (count: number) => `AIとの ${count} 通のチャット`,
    Actions: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      Title: "システムプロンプトの挿入",
      SubTitle:
        "各リクエストのメッセージリストの先頭に、AIのシステムプロンプトを強制的に追加します",
    },
    InputTemplate: {
      Title: "入力の前処理",
