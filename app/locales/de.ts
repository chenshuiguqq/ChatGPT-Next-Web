...
const de: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} Nachrichten mit AI`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromChatGPT: "Nachricht von AI",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Erzwingt das Hinzufügen eines simulierten systemweiten Prompts von AI am Anfang der Nachrichtenliste bei jeder Anfrage",
    },
    Update: {
